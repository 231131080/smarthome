...
// Wi-Fi credentials
const char* ssid = "MyRepublic_EC21_5G";    // nama Wi-Fi anda (SSID)
const char* password = "12345678";  // password Wi-Fi anda

// Firebase credentials
#define API_KEY "AIzaSyB3TeXD8gNZBmrXAk2fQmLm-SIE0K7gjoA"    // Found in Project Settings > General
#define DATABASE_URL "https://testled-5754b-default-rtdb.firebaseio.com/"  // From Realtime Database URL
#define USER_EMAIL "natasya@gmail.com"  // email user saat membuat database
